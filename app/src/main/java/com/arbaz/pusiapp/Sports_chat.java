...
public class Sports_chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_chat);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sports_chat.this, MainActivity.class);
        ...
        database.getReference().child("Sports Chat")
