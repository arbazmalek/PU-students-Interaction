...
public class nonTech_chatGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_tech_chat_group);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(nonTech_chatGroup.this, MainActivity.class);
        ...
        // focusing last postion of meaasge
        ...
        database.getReference().child("non tech Chat")
